...
Users of your function / API have a liberating amount of freedom how they organize their data: on the stack, on the heap, in smart points, in vectors, it doesn't matter.
...
We already a few "view types" for more complex needs:
